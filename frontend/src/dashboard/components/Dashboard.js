...
const AvatarCircle = ({ item, size = 40 }) => {
  ...
  return (
    <div className="rounded-full bg-purple-600 flex items-center justify-center text-white font-bold" style={{ width: size, height: size, fontSize: size * 0.4, flexShrink: 0 }}>
                ...
                filteredSessions.slice(0, 7).map((s) => {
                  return (
                    <div key={s.id} className="flex items-center px-3 py-3 border-b" style={{ borderColor: theme.sidebar_active_bg + '66' }}>
                      <div className="w-8"><input type="checkbox" className="w-4 h-4" /></div>
                      <div className="mr-3"><AvatarCircle item={s} size={40} /></div>
            ...
            <div className="px-6 py-6">
              <div className="flex items-start gap-5">
                ...
                <div className="flex-shrink-0">
                  <AvatarCircle item={modalItem} size={96} />
                </div>
